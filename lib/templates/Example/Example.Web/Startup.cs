...
namespace ProgrammerGrammar.Example.Web
{
    public class Startup
    {
        ...
        {
            services
                .AddAutoMapper(Assembly.GetExecutingAssembly(), Assembly.Load("Example.Core"), Assembly.Load("Example.Infrastructure"))
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSpa(spa =>
            {
                ...
                if (env.IsDevelopment())
                    spa.UseProxyToSpaDevelopmentServer("http://example.webapp:4200");
            });
        }
    }
}